...
[MAC_BASE] = LAYOUT_tkl_ansi(
     ...
     KC_NO,                       KC_Z,              KC_X,              KC_C,              KC_D,       KC_V,     KC_NO,    KC_K,     KC_H,       KC_COMM,             KC_DOT,              LT(1,KC_SCLN),                                                KC_UP,
     KC_NO,    KC_NO,             MT(MOD_HYPR,KC_ESC),                                                           LT(8,KC_SPC),                                        MT(MOD_RGUI,KC_TAB),                    KC_NO, MO(L1), KC_NO,           KC_LEFT,   KC_DOWN,  KC_RGHT
),
...
[L1] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     QK_MAKE,           QK_BOOT,           DB_TOGG,           EE_CLR,     BAT_LVL,  KC_NO,  KC_TRNS,  KC_TRNS,    KC_TRNS,             KC_TRNS,             KC_TRNS,                                                       KC_TRNS,
...
[L3] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     KC_TRNS,           KC_TRNS,           KC_NO,             KC_TRNS,    KC_TRNS,  KC_NO,    KC_TRNS,  KC_P1,     KC_P2,              KC_P3,               KC_PEQL,                                                       KC_UP,
...
[L4] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     KC_TRNS,           KC_NO,             G(KC_Z),           KC_TRNS,    KC_TRNS,  KC_NO,    KC_TRNS,  KC_BRIU,   KC_BRID,            KC_LPAD,             KC_TRNS,                                                       KC_UP,
...
[L5] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     KC_CIRC,           KC_BSLS,           KC_LCBR,           KC_RCBR,    KC_AMPR,  KC_NO,    KC_NO,    KC_NO,     KC_EXLM,            KC_QUES,             KC_SCLN,                                                       KC_UP,
     KC_TRNS,  KC_TRNS,           KC_TRNS,                                                                       KC_TRNS,                                           KC_TRNS,                                KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS,   KC_TRNS,  KC_TRNS
),
...
[L6] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     KC_SCRL,           KC_F1,             KC_F2,             KC_F3,      KC_F4,    KC_NO,    KC_F5,    KC_F6,     KC_NO,              KC_F7,               KC_F8,                                                         KC_UP,
     KC_TRNS,  KC_TRNS,           KC_TRNS,                                                                       KC_TRNS,                                           KC_TRNS,                                KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS,   KC_TRNS,  KC_TRNS
),
...
[L7] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     KC_TRNS,           KC_TRNS,           KC_TRNS,           KC_TRNS,    KC_TRNS,  KC_NO,  KC_TRNS,    DF(L8),        KC_TRNS,        KC_NO,             KC_NO,                                                       KC_TRNS,
     KC_TRNS,  KC_TRNS,           KC_TRNS,                                                                       KC_TRNS,                                           KC_TRNS,                                KC_TRNS, KC_TRNS,  KC_TRNS,      KC_TRNS,   KC_TRNS,  KC_TRNS
),
...
[L8] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     KC_NO,             KC_NO,             KC_BTN3,           KC_NO,      KC_NO,    KC_NO,  KC_NO,      KC_NO,         KC_NO,          KC_NO,             KC_NO,                                                       KC_TRNS,
