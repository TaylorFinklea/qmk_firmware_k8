...
[MAC_BASE] = LAYOUT_tkl_ansi(
     ...
     KC_NO,    KC_NO,             MT(MOD_LGUI,KC_TAB),                                                                 LT(9,KC_SPC),                                        KC_BSPC,             MT(MOD_RGUI,KC_ENT),       MO(L1), KC_NO,          KC_LEFT,   KC_DOWN,  KC_RGHT
),
...
[L1] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     RGB_RMOD,          RGB_VAD,           RGB_HUD,           RGB_SAD,    RGB_SPD,        KC_NO,  KC_TRNS,  KC_TRNS,    KC_TRNS,             KC_TRNS,             KC_TRNS,           KC_TRNS,
                                  QK_MAKE,            KC_NO,             DB_TOGG,           EE_CLR,     BAT_LVL, KC_NO, KC_NO,  EE_CLR,   DB_TOGG,    KC_TRNS,             KC_TRNS,             KC_TRNS,                                                       KC_TRNS,
     KC_TRNS,  KC_TRNS,           QK_BOOT,                                                                             QK_BOOT,                                           QK_BOOT,             QK_MAKE,                    KC_TRNS,  KC_TRNS,      KC_TRNS,   KC_TRNS,  KC_TRNS
),
...
[L2] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     KC_TRNS,           KC_TRNS,           KC_TRNS,           KC_NO,      KC_NO,          KC_NO,  CW_TOGG,  KC_LEFT,   KC_DOWN,            KC_RGHT,             KC_TRNS,           KC_TRNS,
                                  KC_TRNS,           KC_TRNS,           KC_TRNS,           KC_TRNS,    KC_NO,   KC_NO, KC_NO,  KC_TRNS,  KC_PGDN,   G(S(KC_X)),         KC_END,              KC_TRNS,                                                       KC_UP,
     KC_TRNS,  KC_TRNS,           KC_TRNS,                                                                             KC_ESC,                                          KC_DEL,              KC_TRNS,                    KC_TRNS, KC_TRNS,       KC_TRNS,   KC_TRNS,  KC_TRNS
),
...
[L3] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,  KC_TRNS,           KC_TRNS,                                                                             KC_TRNS,                                         KC_TRNS,             KC_P0,                      KC_TRNS, KC_TRNS,       KC_TRNS,   KC_TRNS,  KC_TRNS
),
...
[L4] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     KC_TRNS,           KC_NO,             G(KC_F),           G(KC_A),    KC_TRNS,        KC_NO,    KC_TRNS,  KC_VOLD,   KC_MUTE,            KC_VOLU,             KC_TRNS,           KC_TRNS,   KC_TRNS,              KC_DEL,    KC_END,   KC_PGDN,
...
[L5] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,  KC_TRNS,           KC_TRNS,                                                                             KC_TILD,                                           KC_PEQL,             KC_TRNS,                    KC_TRNS, KC_TRNS,       KC_TRNS,   KC_TRNS,  KC_TRNS
),
...
[L7] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     KC_TRNS,           KC_TRNS,           KC_TRNS,           KC_TRNS,    KC_TRNS,        KC_NO,  DF(L2),     DF(MAC_BASE),  KC_TRNS,        KC_NO,             KC_TRNS,           KC_TRNS,
                                  KC_TRNS,           KC_TRNS,           KC_TRNS,           KC_TRNS,    KC_TRNS, KC_NO, KC_NO,  DF(L9),     DF(L8),        KC_TRNS,        KC_NO,             KC_NO,                                                       KC_TRNS,
     KC_TRNS,  KC_TRNS,           KC_TRNS,                                                                             KC_TRNS,                                           KC_TRNS,                                KC_TRNS, KC_TRNS,  KC_TRNS,      KC_TRNS,   KC_TRNS,  KC_TRNS
),
...
[L8] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     KC_BTN4,           KC_BTN2,           KC_WH_D,           KC_BTN1,    KC_BTN5,        KC_NO,  KC_NO,      KC_MS_L,       KC_MS_D,        KC_MS_R,           KC_NO,             KC_TRNS,
                                  KC_NO,             KC_NO,             KC_BTN3,           KC_NO,      KC_NO,   KC_NO, KC_NO,  KC_NO,      KC_NO,         KC_NO,          KC_NO,             DF(MAC_BASE),                                                       KC_TRNS,
...
[L9] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,                     KC_NO,             KC_WH_L,           KC_WH_U,           KC_WH_R,    KC_NO,          KC_NO,  KC_NO,      KC_WH_L,       KC_WH_U,        KC_WH_R,           KC_NO,             KC_TRNS,   KC_TRNS,              KC_TRNS,   KC_TRNS,  KC_TRNS,
     KC_TRNS,                     KC_BTN4,           KC_BTN2,           KC_WH_D,           KC_BTN1,    KC_BTN5,        KC_NO,  KC_BTN4,    KC_BTN1,       KC_WH_D,        KC_BTN2,           KC_BTN5,             KC_TRNS,
                                  KC_NO,             KC_NO,             KC_BTN3,           KC_NO,      KC_NO,   KC_NO, KC_NO,  KC_NO,      KC_NO,         KC_BTN3,        KC_NO,             DF(MAC_BASE),                                                       KC_TRNS,
     KC_TRNS,  KC_TRNS,           KC_TRNS,                                                                             KC_NO,                                             KC_TRNS,                                KC_TRNS, KC_TRNS,  KC_TRNS,      KC_TRNS,   KC_TRNS,  KC_TRNS
),
